...
func _ready() -> void:
	...
	await o.say("Sen","\"Oh hey I know that game!\"")
	...
	await q.say("Quickshot", "\"You've done this before, and you know where the things will need to go.\"")
	...
	await o.say("Sentry", "\"I'll bring the newbie with me. I could use the extra help.\"")
	...
	await o.say("YOU", "Sen grabs my arm, practically dragging me out of the room and into the hallway.")
	await o.say("Sentry", "\"Those computers aren't going to fetch themselves!\"")
	await o.say("YOU", "Once again Sentry begins to pull my arm, dragging me through the halls.")
	await o.say("YOU", "\"Woah slow down!\"")
	await o.say("YOU", "Finally arriving at the gym, I take a moment to catch my breath after being dragged across the school.")
	await o.say("YOU", "Sentry wastes no time, he walks over to the computer storage and begins to look for the ones we need.")
	...
	await o.say("YOU", "We take the amount we need from the storage, making extra sure to lock up after.")
	...
	await o.say("YOU", "\"Well in that case, I could look around the school a bit while making my way back.\"")
	...
	await o.say("YOU", "Sen takes the computers off my hands and runs down the hall, how he somehow manages to not drop any of them is beyond me.")
	await o.say("YOU", "I was as he slowly disappears down the hall, leaving me alone in a far corner of the school.")
	await o.say("YOU", "I begin to walk back towards the club like we planned. While also looking down other hallways, stairs and even into other classroom for any sign of Ravager.")
	await o.say("YOU", "Strangely though there doesn't seem to be anyone else. The place is completely deserted.")
	await o.say("YOU", "Just as I thought I was the only one left in the school, a familiar face shows up.")
